pipeline{
    ...
    stages{
       ...
       stage("Clean up before building") {
        ...
        stage ("Emailing"){
            steps {
              //  emailext (attachLog: true, body: "Here is the pipeline logs for microservices project build N° ${BUILD_ID}", to: 'salah.gontara@polytecsousse.tn' , subject: "Pipeline Microservices Logs Build N° ${BUILD_ID}")
